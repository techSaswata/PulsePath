 ...
 *  - Build 2: multi-agent debate transcript
 *  - Build 8/9: evidence citations + similar prior cases
...
export function AssessmentView({
  ...
  return (
    <div className="space-y-5">
      ...
      <div className={`rounded-2xl border ${s.ring} ${s.bg} p-5`}>
        <div className="flex flex-col items-start justify-between gap-4 sm:flex-row sm:items-center">
          ...
          <div className="flex gap-2">
            ...
            <button onClick={downloadPdf} disabled={downloading} className="btn-ghost">
      ...
      {/* --- Build 2: debate transcript --- */}
      <Section title="How the AI care team reasoned (multi-agent debate)">
        <div className="space-y-2.5">
          {a.debate.map((c, i) => (
            <div key={i} className="flex gap-3">
              <span className="mt-0.5 flex-none rounded-md bg-brand-50 px-2 py-1 text-[11px] font-bold uppercase tracking-wide text-brand-700">
                {c.agent}
              </span>
              <div>
      ...
      {/* --- Build 8/9: evidence + similar cases --- */}
      <div className="grid gap-5 md:grid-cols-2">
        {a.citations.length > 0 && (
          <Section title="Evidence (clinical guidelines)">
        ...
        {a.similarCases.length > 0 && (
          <Section title="Most similar previous cases">
            <ul className="space-y-2">
